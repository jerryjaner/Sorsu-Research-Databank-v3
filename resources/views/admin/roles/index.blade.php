                    ...
                    <div class="alert alert-primary d-flex align-items-start mb-4">
                        ...
                        <div>
                            ...
                            <p class="mb-0 text-muted">
                                Please complete all required fields below to add a new role to the system. Make sure the
                                role name is unique and accurate.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label class="form-check form-check-custom form-check-solid">
                            <input class="form-check-input me-2" type="checkbox" id="select_all_permissions">
                            <span class="fw-bold text-primary">Select All Permissions</span>
                        </label>
                    </div>
...
<script>
    ...
    // Sync individual checkbox → Select All
    ...
    $('#savePermissionsBtn').on('click', function() {
        ...
        .done(function(response){
            ...
            Swal.fire({
                icon: 'success',
                title: response.message || 'Permissions updated successfully',
                timer: 1500,
                showConfirmButton: false
            });
