...
<head><base href="">
    ...
    <link rel="canonical"/>
    <link rel="shortcut icon" href="{{ asset('student/assets/media/logos/ssu-logo.png') }}" />
    <!--begin::Fonts-->
...
<!--end::Head-->
<!--begin::Body-->
<body id="kt_body" style="background-image: url('{{ asset('student/assets/media/patterns/header-bg-red.png') }}');" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled">
...
<script src="{{URL::to('student/assets/plugins/global/plugins.bundle.js')}}"></script>
...
<!--end::Javascript-->
<script src="{{ URL::to('student/assets/plugins/custom/datatables/datatables.bundle.js')}}"></script>
