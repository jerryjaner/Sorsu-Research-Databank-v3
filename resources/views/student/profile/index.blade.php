...
<div id="kt_content_container" class="d-flex flex-column-fluid align-items-start container-xxl">
    <div class="content flex-row-fluid" id="kt_content">
        <div class="card">
            <form id="profile-form" class="form" action="{{ route('student-profile-account.update') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body p-9">
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8">
                            <input type="text" name="role" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Role" value="{{ ucwords(str_replace('_', ' ', Auth::user()->getRoleNames()->first() )) }}" readonly/>
                            @error('role')
                                <span class="text-danger mt-1">{{ $message }}</span>
                            @enderror
                        </div>
